...
if(isset($_GET['company']) && $_GET['company'] != 'all') {
    ...
    $queryPhones = "SELECT * FROM phones WHERE companyID = '$selectedCompany'";
} else {
    $queryPhones = "SELECT * FROM phones";
}
        ...
        <div class="container py-5">
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="col">
<label>
    <input type="radio" name="company" value="all" <?php if (!isset($_GET['company']) || $_GET['company'] === 'all') { echo 'checked'; } ?>>
    All
</label>
<?php for ($i = 0; $i < count($companies); $i++) { ?>
  <label>
    <input type="radio" name="company" value="<?php echo $companies[$i]['companyID']; ?>" <?php if (isset($_GET['company']) && $_GET['company'] === $companies[$i]['companyName']) { echo 'checked'; } ?>>
    <?php echo $companies[$i]['companyName']; ?>
  </label>
<?php } ?>
                </div>
                <div class="col">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product image-->
                        <img class="card-img-top" src="<?php echo $phone['images']; ?>" alt="..." />
                        <!-- Product details-->
        ...
        <div class="container px-4 px-lg-5">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-4 text-lg-start">
                    <p class="text-muted small mb-4 mb-lg-0">&copy; Your Website 2021</p>
                </div>
