...
<!--Bootstrap Template from https://startbootstrap.com/previews/shop-item-->
  ...
  <div class="col">
   ...
   <!-- <p>Operating System: <?php echo $phone['operating_system']; ?></p> -->
    <!-- Include any additional information about the phone that you want to display -->
            ...
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Phone Catalogue 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
